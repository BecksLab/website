...
First and foremost, we are an open science lab. There are several major facets to this, but the core is: the way this lab operates is inspired by the time that Tanya spent at the [Poisot lab](https://poisotlab.io/values/) and rests on the belief that participation in science is a public act, and done for public good. As such it is essential that we give back what we take from the community, while striving to cultivate a research space that is healthy, collaborative, and a truly inclusive.
